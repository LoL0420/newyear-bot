...
# Ваш токен
BOT_TOKEN = "8311030733:AAFP0I85fxRM2q0o65v5_CRV1cP0V-APvWM"
...
async def countdown_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Прогресс-бар (10 эмодзи)
    filled = min(10, max(1, 365 - days) // 36)
...
async def progress_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    percent_done = ((365 - days) / 365) * 100
    percent_left = (days / 365) * 100

    # Визуализация (10 эмодзи)
    done_emojis = int(percent_done / 10)  # 10 эмодзи = 100%
    left_emojis = 10 - done_emojis

    # Создаем прогресс-бар (ОТДЕЛЬНАЯ ПЕРЕМЕННАЯ)
    ...
    message = (
        f"📊 <b>Прогресс {datetime.now().year} года:</b>\n\n"
...
def main():
    ...
    print("🔗 Ссылка: https://t.me/new_year_bebe_bot")
    print("=" * 60)
